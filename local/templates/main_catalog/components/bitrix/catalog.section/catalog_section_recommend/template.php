...
if (!empty($arResult['ITEMS'])) {
    ...
    <? } ?>
        ...
        foreach ($arResult['ITEMS'] as $key => $arItem) {
            ...
            <div class="col-xs-12 col-md-3 shop__item" id="<? echo $strMainID; ?>">
                ...
                <?}?>
                <div class="shop__item-title"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                                                 title="<? echo $productTitle; ?>"><? echo $productTitle; ?></a></div>

                <div class="shop__item-quantity">
                   <?if($arItem['CATALOG_QUANTITY'] > 0)
                       echo GetMessage('CT_BCS_CATALOG_CATALOG_QUANTITY_MEASURE_YES');
                    else
                        echo GetMessage('CT_BCS_CATALOG_CATALOG_QUANTITY_MEASURE_NO');
                   ?>
                </div>
                <div class="shop__item-price">
                    ...
                    <div class="col-xs-6">
                        <? if ($arItem['CAN_BUY']) { ?>
                            <div class="shop__item-btn" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
                ...
                <?if($arItem['PROPERTIES']['SHIRINA_SVETILNIKA']['VALUE'] !="" && $arItem['PROPERTIES']['VYSOTA_SVETILNIKA']['VALUE'] !=""):?>
                    <div class="shop__item-razmer">
                        <span><?=$arItem['PROPERTIES']['SHIRINA_SVETILNIKA']['VALUE']?> см</span>
                        <em><?=$arItem['PROPERTIES']['VYSOTA_SVETILNIKA']['VALUE']?> см</em>
                    </div>
                <?endif?>

                <div class="shop__item-bages">
                    <? if ($minPrice['DISCOUNT_VALUE'] < $minPrice['VALUE']): ?>
                        <div
