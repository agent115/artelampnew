...
if (!empty($arResult['ITEMS'])) {
    ...
    <div class="row shop__items">
        ...
        foreach ($arResult['ITEMS'] as $key => $arItem) {
            ...
            <?endif;?>
            <div class="<?if($i==1 || $i==4):?>col-xs-12 col-md-3 shop__item<?endif;?> <?if($i==2 || $i==3):?>col-xs-12 shop__item--horizontal<?endif;?>" id="<? echo $strMainID; ?>">

                <?//левый и правый элементы
                if($i==1 || $i==4){?>
                ...
                <div class="shop__item-price">
                    <div class="col-xs-6"><span></span><span><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price"><?
                                if (!empty($minPrice)) {
                ...
                <div class="shop__item-bages">
                    <?if($arItem['PROPERTIES']['NOVINKA']['VALUE']):?> <div class="shop__item-bage shop__item-bage--new"></div><?endif;?>
                </div>
                <?}?>
                ...
                if($i==2 || $i==3){?>
                        ...
                        <div class="col-xs-12 col-md-7 col-md-offset-1">
                            ...
                            <div class="shop__item-price">
                                <div class="col-xs-6 col-md-4"><span></span><span><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price"><?
                                            if (!empty($minPrice)) {
                                                if ('N' == $arParams['PRODUCT_DISPLAY_MODE'] && isset($arItem['OFFERS']) && !empty($arItem['OFFERS'])) {
                                                    echo GetMessage(
                                                        'CT_BCS_TPL_MESS_PRICE_SIMPLE_MODE',
