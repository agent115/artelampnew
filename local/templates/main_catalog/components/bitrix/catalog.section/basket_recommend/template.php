...
if (!empty($arResult['ITEMS'])) {
    ...
    <? } ?>
    <ul class="col-xs-12 col-md-12 basket__additional">
        <? $i = 0; ?>
        <?
        foreach ($arResult['ITEMS'] as $key => $arItem) {
            ...
            ?>
        <li class="col-xs-12 col-md-3" id="<? echo $strMainID; ?>">
                ...
                <?}?>
            <div class="basket__additional-info">
                <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                   title="<? echo $productTitle; ?>"><? echo $productTitle; ?></a>
                <div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price">
                    <em><?echo $minPrice['PRINT_DISCOUNT_VALUE'];?></em>
                </div>
                <i>(комплект <?=$arItem['NEW_QUANTITY']?>шт = <?=CurrencyFormat($arItem['NEW_QUANTITY']*$minPrice['DISCOUNT_VALUE'],'RUB')?>) </i>
                <? if ($arItem['CAN_BUY']) { ?>
                    <div class="basket__additional-btn" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
                        <a class="basket__additional-info-buy-btn" id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_button bx_medium"
                ...
                <div class="bx_catalog_item_controls_blockone"><div style="display: none;">
                        ...
                        <input type="text" class="bx_col_input" id="<? echo $arItemIDs['QUANTITY']; ?>" name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<? echo $arItem['NEW_QUANTITY']; ?>">
