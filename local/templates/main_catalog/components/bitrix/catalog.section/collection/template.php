...
if (!empty($arResult['ITEMS'])) {
    ...
    <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
        ...
        <ul class="indexCatalog__items col-xs-12">
            <? $i = 0; ?>
            <?
            foreach ($arResult['ITEMS'] as $key => $arItem) {
                ...
                <li class="col-xs-12 col-md-4 indexCatalog__item" id="<? echo $strMainID; ?>">
                    <img id="<? echo $arItemIDs['PICT']; ?>" src="<? echo $arItem['DETAIL_PICTURE']['SRC']; ?>" alt="">
                    ...
                    <div class="indexCatalog__item-title"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>"
                                                     title="<? echo $productTitle; ?>"><? echo $productTitle; ?></a></div>

                    <div
                        class="indexCatalog__item-quantity"><?= Loc::getMessage('CT_BCS_CATALOG_CATALOG_QUANTITY_TEXT') ?> <?= $arItem['CATALOG_QUANTITY'] ?> <?= $arItem['CATALOG_MEASURE_NAME'] ?>
                        .
                    </div>
