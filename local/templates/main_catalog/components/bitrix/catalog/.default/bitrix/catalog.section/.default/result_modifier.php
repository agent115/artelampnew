...
foreach ($arResult["ITEMS"] as $key=>$arItem){
    $arItem["PREVIEW_PICTURE"]= $arItem["DETAIL_PICTURE"] = $arItem["PREVIEW_PICTURE"]?$arItem["PREVIEW_PICTURE"]:$arItem["DETAIL_PICTURE"];
    if($arItem["PREVIEW_PICTURE"]!="")
    {
        $pic = CFile::ResizeImageGet($arItem["PREVIEW_PICTURE"]["ID"], array("width" => 250, "height" => 200),BX_RESIZE_IMAGE_PROPORTIONAL_ALT );
        $arResult["ITEMS"][$key]["DETAIL_PICTURE"]["SRC"] =  $arResult["ITEMS"][$key]["PREVIEW_PICTURE"]["SRC"] = $pic["src"];
    }
}
