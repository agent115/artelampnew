...
if (!empty($arResult['ITEMS'])) {
    ...
    <div class="col-xs-12 col-sm-12 col-md-9 col-md-offset-1">
        <div class="indexCatalog__title"><?=$arResult['NAME']?></div>

        <? echo $arResult["NAV_STRING"]; ?>

        <div class="col-xs-12 indexCatalog__submenu">
            <? /*$APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "EDIT_TEMPLATE" => "",
                    "PATH" => "/include/main_catalog_template/catalog_links.php"
                )
            );*/?>

        </div>
        <ul class="indexCatalog__items col-xs-12 normalBlocks">
            <? $i = 0; ?>
            <?
            ...
            return $matches[1].ucfirst($matches[2])." ".ToUpper($matches[3]);
                ...
                <li class="col-xs-12 col-md-4 indexCatalog__item borderRight" id="<? echo $strMainID; ?>">
                    <div class="item__pic">
                        <div class="item__pic--inside">
                            <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>">
                    <img id="<? echo $arItemIDs['SECOND_PICT']; ?>" src="<? echo $arItem['DETAIL_PICTURE']['SRC']; ?>" alt="">
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="indexCatalog__item-title">
                        <a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>"><? echo $productTitle; ?></a>
                    </div>
                    <!--<div class="indexCatalog__item-quantity"><?//= Loc::getMessage('CT_BCS_CATALOG_CATALOG_QUANTITY_TEXT') ?> <?//= $arItem['CATALOG_QUANTITY'] ?> <?//= $arItem['CATALOG_MEASURE_NAME'] ?>.</div>-->
                    <div class="indexCatalog__item-quantity"><?=($arItem['CATALOG_QUANTITY'] > 0) ? 'в наличии' : ''?></div>
                    <div class="indexCatalog__item-price">
                        <div class="col-xs-6"><div id="<? echo $arItemIDs['PRICE']; ?>" class="bx_price"><?
                                    if (!empty($minPrice)) {
                        ...
                        <div class="col-xs-6">
                            <? if ($arItem['CAN_BUY']) { ?>
                                <div class="indexCatalog__item-btn" id="<? echo $arItemIDs['BASKET_ACTIONS']; ?>">
                    ...
                    <?if(!empty($arItem['PROPERTIES']['SHIRINA_SVETILNIKA']['VALUE']) && !empty($arItem['PROPERTIES']['VYSOTA_SVETILNIKA']['VALUE'])){?>
                        <div class="indexCatalog__item-razmer">
                            <span><?= $arItem['PROPERTIES']['SHIRINA_SVETILNIKA']['VALUE'] ?> см</span>
                            <em><?= $arItem['PROPERTIES']['VYSOTA_SVETILNIKA']['VALUE'] ?> см</em>
                        </div>
                    <?}?>

                    <div class="indexCatalog__item-bages">
                        <? if ($minPrice['DISCOUNT_VALUE'] < $minPrice['VALUE']): ?>
                            <div
                                class="shop__item-bage shop__item-bage--discount"><?//=$minPrice['DISCOUNT_DIFF_PERCENT']?></div><?endif; ?>
                        <? if ($arItem['PROPERTIES']['NOVINKA']['VALUE'] == 'да' || $arItem['PROPERTIES']['NOVINKA']['VALUE'] == 'Да'): ?>
                            <div class="shop__item-bage shop__item-bage--new"></div><?endif; ?>
                        <? if ($arItem['PROPERTIES']['SALE']['VALUE'] == 'да' || $arItem['PROPERTIES']['SALE']['VALUE'] == 'Да'): ?>
                            <div class="indexCatalog__item-bage indexCatalog__item-bage--order"></div><?endif; ?>
                         <? if ($arItem['PROPERTIES']['HIT']['VALUE'] == 'да' || $arItem['PROPERTIES']['HIT']['VALUE'] == 'Да'): ?>
                             <div class="indexCatalog__item-bage indexCatalog__item-bage--hit"></div>
                        <?endif?>
                        <? if ($arItem['PROPERTIES']['SHOW_ROOM']['VALUE'] == 'да' || $arItem['PROPERTIES']['SHOW_ROOM']['VALUE'] == 'Да'): ?>
                             <div class="indexCatalog__item-bage indexCatalog__item-bage--show"></div>
                        <?endif?>
                    </div>
