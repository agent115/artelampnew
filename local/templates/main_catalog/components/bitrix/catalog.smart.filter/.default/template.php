...
<div class="bx-filter">
	...
	<div class="indexCatalog__param-title"><?echo GetMessage("CT_BCSF_FILTER_TITLE")?></div>
	...
	<form name="<?echo $arResult["FILTER_NAME"]."_form"?>" action="<?echo $arResult["FORM_ACTION"]?>" method="get" class="smartfilter">
		...
		<?foreach($arResult["ITEMS"] as $key=>$arItem)//prices
		{
			...
			if(isset($arItem["PRICE"])):
				...
				<span><?=Loc::getMessage('CT_BCSF_PRICE_TITLE')?> </span>
				<div class="indexCatalog__param-price" data-role="bx_filter_block">
					<div class="extra-controls">
						<?=Loc::getMessage('CT_BCSF_FILTER_FROM')?>
						<input
							class="min-price"
							type="text"
						...
						<?=Loc::getMessage('CT_BCSF_FILTER_TO')?>
						<input
							class="max-price"
							type="text"
		...
		foreach($arResult["ITEMS"] as $key=>$arItem)
		{
			...
			<div class="bx-filter-parameters-box <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>bx-active<?endif?>">
				...
				<a class="indexCatalog__open <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>indexCatalog__close<?endif?>" data-role="bx_filter_link_name" onclick="smartFilter.hideFilterProps(this)">
					<?=$arItem["NAME"]?>
				</a>

				<div class="bx-filter-block" data-role="bx_filter_block" <?if ($arItem["DISPLAY_EXPANDED"]== "Y"):?>style="display:block"<?endif?>>
					<div class="bx-filter-parameters-box-container">
									...
									<label for="<?=$ar["CONTROL_ID"]?>" data-role="label_<?=$ar["CONTROL_ID"]?>" class="bx-filter-param-label<?=$class?>" onclick="smartFilter.keyup(BX('<?=CUtil::JSEscape($ar["CONTROL_ID"])?>')); BX.toggleClass(this, 'bx-active');">
                                            ...
                                            <span class="bx-filter-param-text" title="<?=$ar["VALUE"];?>"><?=$ar["VALUE"];?><?
												if ($arParams["DISPLAY_ELEMENT_COUNT"] !== "N" && isset($ar["ELEMENT_COUNT"])):
													?> (<div class="count_block_div" data-role="count_<?=$ar["CONTROL_ID"]?>"><? echo $ar["ELEMENT_COUNT"]; ?></div>)<?
												endif;?></span>
									</label>
								<?endforeach?>
							</div>
						...
						?>
						<?foreach($arItem["VALUES"] as $val => $ar):?>
							<div class="indexCatalog__checkbox">
								<input
									type="checkbox"
		...
		<hr>
		<div class="col-xs-12">
			<div class="indexCatalog__param-btn indexCatalog__param-btn--reset">
				<input
		...
		<div class="col-xs-12">
			<div class="indexCatalog__param-btn indexCatalog__param-btn--apply">
				<input
		...
		<div class="bx-filter-popup-result <?if ($arParams["FILTER_VIEW_MODE"] == "VERTICAL") echo $arParams["POPUP_POSITION"]?>" id="modef" <?if(!isset($arResult["ELEMENT_COUNT"])) echo 'style="display:none"';?> style="display: inline-block;">
			...
			<br/>
			<a href="<?echo $arResult["FILTER_URL"]?>" class="modef_link" target=""><?echo GetMessage("CT_BCSF_FILTER_SHOW")?></a>
		</div>
