...
?>
	...
	<form role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>"  onsubmit="BX('bx_subscribe_btn_<?=$buttonId?>').disabled=true;">
		...
		<input type="hidden" name="sender_subscription" value="add">
			...
			<label>
				<input class="" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="<?=$arResult["EMAIL"]?>" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
			</label>
		...
		<?endforeach;?>
			...
			<button class="footer__btn" id="bx_subscribe_btn_<?=$buttonId?>"><?=GetMessage("subscr_form_button")?></button>
...
?>
	...
	<form role="form" method="post" action="<?=$arResult["FORM_ACTION"]?>"  onsubmit="BX('bx_subscribe_btn_<?=$buttonId?>').disabled=true;">
		...
		<input type="hidden" name="sender_subscription" value="add">
			...
			<label>
				<input class="" type="email" name="SENDER_SUBSCRIBE_EMAIL" value="" title="<?=GetMessage("subscr_form_email_title")?>" placeholder="<?=htmlspecialcharsbx(GetMessage('subscr_form_email_title'))?>">
			</label>
