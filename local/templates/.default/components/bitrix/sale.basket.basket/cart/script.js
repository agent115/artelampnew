/**
 * Created by Vampiref92 on 05.10.2016.
 */
/**
 * @param basketItemId
...
function recalcBasketAjax(params)
{
	...
	var property_values = {},
			...
			rowsItems = BX.findChildren(items, {className: 'tr'}, true),
	...
	if (!!items && rowsItems.length > 0)
	{

		for (i = 0; rowsItems.length > i; i++) {
			var BasketElementId = rowsItems[i].getAttribute('id');

			postData['QUANTITY_' + BasketElementId] = BX('QUANTITY_' + BasketElementId).value;
		}
	}
