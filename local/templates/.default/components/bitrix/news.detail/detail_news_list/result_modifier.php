...
if(count($arItems)==3):
    $arResult["TORIGHT"] = Array("NAME"=>$arItems[0]["NAME"], "URL"=>$arItems[0]["DETAIL_PAGE_URL"],"ID"=>$arItems[0]["ID"]);
    $arResult["TOLEFT"] = Array("NAME"=>$arItems[2]["NAME"], "URL"=>$arItems[2]["DETAIL_PAGE_URL"], "ID"=>$arItems[2]["ID"]);
elseif(count($arItems)==2):
    if($arItems[0]["ID"]!=$arResult["ID"])
        $arResult["TORIGHT"] = Array("NAME"=>$arItems[0]["NAME"], "URL"=>$arItems[0]["DETAIL_PAGE_URL"],  "ID"=>$arItems[0]["ID"]);
    else
        $arResult["TOLEFT"] = Array("NAME"=>$arItems[1]["NAME"], "URL"=>$arItems[1]["DETAIL_PAGE_URL"], "ID"=>$arItems[1]["ID"]);
endif;
