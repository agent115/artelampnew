...
?>
<div class="indexCatalog__pagination">
<?
$ar = array();
?>
...
<?else:?>
    ...
    <?if(!$ar[$arResult["NavPageCount"] - 1]):?>
        <a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]-1?>"><span class="news__pagination-radial"><?=$arResult["NavPageCount"]-1?></span></a>
    <?endif?>
    <?if(!$ar[$arResult["NavPageCount"]]):?>
		<a href="<?=$arResult["sUrlPath"]?>?<?=$strNavQueryString?>PAGEN_<?=$arResult["NavNum"]?>=<?=$arResult["NavPageCount"]?>"><span class="news__pagination-radial"><?=$arResult["NavPageCount"]?></span></a>
	<?endif?>
