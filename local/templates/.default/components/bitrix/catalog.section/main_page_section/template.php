...
if (!empty($arResult['ITEMS'])) {
    ...
    ?>
    <ul class="light__suspension-list">
        <? $i = 0; ?>
        <?
        foreach ($arResult['ITEMS'] as $key => $arItem) {
            ...
            ?>
            <li class="col-sm-3" style="background: url(<? echo $arItem['DETAIL_PICTURE']['SRC']; ?>) 50% 20px no-repeat #fff;" id="<? echo $strMainID; ?>">
                <a href="<?=$arItem['DETAIL_PAGE_URL'];?>">
							<span class="light__suspension-list_title">
								<? echo $productTitle; ?>
							</span>
                    <?/*<span class="light__suspension-list_price"><?if (!empty($minPrice)) {
