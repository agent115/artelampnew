	...
	<input type="hidden" name="bigdata_recommendation_id" value="<?=htmlspecialcharsbx($arResult['RID'])?>">
		...
		<div class="row">
            <div class="shopItem__collection">
                <div class="shopItem__collection-title">С этим товаром смотрели</div>
                <div class="shopItem__collection-btn">
					<a class="recommend_collection_link" href="/catalog/<?=$arResult['_ORIGINAL_PARAMS']['SECTION_CODE']?>/">
						Вся коллекция
					</a>
					<?/*/catalog/<?=$arResult['_ORIGINAL_PARAMS']['SECTION_CODE']?>*/?>
				</div>
